...
namespace VTS.Core
{
    ...
    public class CoreVTSPlugin : IVTSPlugin, IDisposable
    {
        ...
        public string PluginIcon { get; set; } // che it takoe? 
        ...
        public CoreVTSPlugin(IVTSLogger logger, int updateIntervalMs, string pluginName, string pluginAuthor,
            string pluginIcon)
        {
        ...
        public void Initialize(IWebSocket webSocket, IJsonUtility jsonUtility, ITokenStorage tokenStorage,
            Action onConnect, Action onDisconnect, Action<VTSErrorData> onError)
        {
        ...
        public Task InitializeAsync(IWebSocket webSocket, IJsonUtility jsonUtility, ITokenStorage tokenStorage,
            Action onDisconnect)
        {
        ...
        public void MoveModel(VTSMoveModelData.Data position, Action<VTSMoveModelData> onSuccess,
            Action<VTSErrorData> onError)
        {
        ...
        {
            return await VTSExtensions
                .Async<VTSMoveModelData.Data, VTSMoveModelData, VTSErrorData>(MoveModel, position);
        }

        // Get Hotkeys in Model

        public void GetHotkeysInCurrentModel(string modelID, Action<VTSHotkeysInCurrentModelData> onSuccess,
            Action<VTSErrorData> onError)
        {
        ...
        {
            return await VTSExtensions.Async<string, VTSHotkeysInCurrentModelData, VTSErrorData>(
                GetHotkeysInCurrentModel, modelId);
        }

        // Get Hotkeys in Item

        public void GetHotkeysInLive2DItem(string live2DItemFileName, Action<VTSHotkeysInCurrentModelData> onSuccess,
            Action<VTSErrorData> onError)
        {
            VTSHotkeysInCurrentModelData request = new VTSHotkeysInCurrentModelData();
        ...
        {
            return await VTSExtensions.Async<string, VTSHotkeysInCurrentModelData, VTSErrorData>(GetHotkeysInLive2DItem,
                live2DItemFileName);
        }
        ...
        public void TriggerHotkeyForLive2DItem(string itemInstanceID, string hotkeyID,
            Action<VTSHotkeyTriggerData> onSuccess, Action<VTSErrorData> onError)
        {
            VTSHotkeyTriggerData request = new VTSHotkeyTriggerData();
            request.data.hotkeyID = hotkeyID;
        ...
        {
            return await VTSExtensions.Async<string, string, VTSHotkeyTriggerData, VTSErrorData>(
                TriggerHotkeyForLive2DItem, itemInstanceId, hotkeyId);
        }
        ...
        public void TintArtMesh(ColorTint tint, float mixWithSceneLightingColor, ArtMeshMatcher matcher,
            Action<VTSColorTintData> onSuccess, Action<VTSErrorData> onError)
        {
        ...
        public async Task<VTSColorTintData> TintArtMesh(ColorTint tint, float mixWithSceneLightingColor,
            ArtMeshMatcher matcher)
        {
            return await VTSExtensions.Async<ColorTint, float, ArtMeshMatcher, VTSColorTintData, VTSErrorData>(
                TintArtMesh, tint, mixWithSceneLightingColor, matcher);
        }
        ...
        public void GetParameterValue(string parameterName, Action<VTSParameterValueData> onSuccess,
            Action<VTSErrorData> onError)
        {
        ...
        {
            return await VTSExtensions.Async<string, VTSParameterValueData, VTSErrorData>(GetParameterValue,
                parameterName);
        }
        ...
        public void AddCustomParameter(VTSCustomParameter parameter, Action<VTSParameterCreationData> onSuccess,
            Action<VTSErrorData> onError)
        {
        ...
        {
            return await VTSExtensions.Async<VTSCustomParameter, VTSParameterCreationData, VTSErrorData>(
                AddCustomParameter, parameter);
        }

        // Remove Custom Parameter

        public void RemoveCustomParameter(string parameterName, Action<VTSParameterDeletionData> onSuccess,
            Action<VTSErrorData> onError)
        {
        ...
        {
            return await VTSExtensions.Async<string, VTSParameterDeletionData, VTSErrorData>(RemoveCustomParameter,
                parameterName);
        }

        // Inject Parameter Values

        public void InjectParameterValues(VTSParameterInjectionValue[] values, Action<VTSInjectParameterData> onSuccess,
            Action<VTSErrorData> onError)
        {
        ...
        {
            return await VTSExtensions.Async<VTSParameterInjectionValue[], VTSInjectParameterData, VTSErrorData>(
                InjectParameterValues, values);
        }

        public void InjectParameterValues(VTSParameterInjectionValue[] values, VTSInjectParameterMode mode,
            Action<VTSInjectParameterData> onSuccess, Action<VTSErrorData> onError)
        {
            InjectParameterValues(values, mode, false, onSuccess, onError);
        }

        public async Task<VTSInjectParameterData> InjectParameterValues(VTSParameterInjectionValue[] values,
            VTSInjectParameterMode mode)
        {
            return await VTSExtensions
                .Async<VTSParameterInjectionValue[], VTSInjectParameterMode, VTSInjectParameterData, VTSErrorData>(
                    InjectParameterValues, values, mode);
        }

        public void InjectParameterValues(VTSParameterInjectionValue[] values, VTSInjectParameterMode mode,
            bool faceFound, Action<VTSInjectParameterData> onSuccess, Action<VTSErrorData> onError)
        {
        ...
        public async Task<VTSInjectParameterData> InjectParameterValues(VTSParameterInjectionValue[] values,
            VTSInjectParameterMode mode, bool faceFound)
        {
            return await VTSExtensions
                .Async<VTSParameterInjectionValue[], VTSInjectParameterMode, bool, VTSInjectParameterData,
                    VTSErrorData>(InjectParameterValues, values, mode, faceFound);
        }
        ...
        public void SetExpressionState(string expression, bool active, Action<VTSExpressionActivationData> onSuccess,
            Action<VTSErrorData> onError)
        {
        ...
        {
            return await VTSExtensions.Async<string, bool, VTSExpressionActivationData, VTSErrorData>(
                SetExpressionState, expression, active);
        }
        ...
        public void SetCurrentModelPhysics(VTSPhysicsOverride[] strengthOverrides, VTSPhysicsOverride[] windOverrides,
            Action<VTSOverrideModelPhysicsData> onSuccess, Action<VTSErrorData> onError)
        {
        ...
        public async Task<VTSOverrideModelPhysicsData> SetCurrentModelPhysics(VTSPhysicsOverride[] strengthOverrides,
            VTSPhysicsOverride[] windOverrides)
        {
            return await VTSExtensions
                .Async<VTSPhysicsOverride[], VTSPhysicsOverride[], VTSOverrideModelPhysicsData, VTSErrorData>(
                    SetCurrentModelPhysics, strengthOverrides, windOverrides);
        }

        // Set NDI Config

        public void SetNDIConfig(VTSNDIConfigData config, Action<VTSNDIConfigData> onSuccess,
            Action<VTSErrorData> onError)
        {
        ...
        public void GetItemList(VTSItemListOptions options, Action<VTSItemListResponseData> onSuccess,
            Action<VTSErrorData> onError)
        {
        ...
        {
            return await VTSExtensions.Async<VTSItemListOptions, VTSItemListResponseData, VTSErrorData>(GetItemList,
                options);
        }

        // Load Item

        public void LoadItem(string fileName, VTSItemLoadOptions options, Action<VTSItemLoadResponseData> onSuccess,
            Action<VTSErrorData> onError)
        {
        ...
        {
            return await VTSExtensions.Async<string, VTSItemLoadOptions, VTSItemLoadResponseData, VTSErrorData>(
                LoadItem, fileName, options);
        }

        public void LoadCustomDataItem(string fileName, string base64, VTSCustomDataItemLoadOptions options,
            Action<VTSItemLoadResponseData> onSuccess, Action<VTSErrorData> onError)
        {
            VTSItemLoadRequestData request = new VTSItemLoadRequestData();
            request.data.fileName = fileName;
            request.data.positionX = options.positionX;
        ...
        public async Task<VTSItemLoadResponseData> LoadCustomDataItem(string fileName, string base64,
            VTSCustomDataItemLoadOptions options)
        {
            return await VTSExtensions
                .Async<string, string, VTSCustomDataItemLoadOptions, VTSItemLoadResponseData, VTSErrorData>(
                    LoadCustomDataItem, fileName, base64, options);
        }

        // Unload Item

        public void UnloadItem(VTSItemUnloadOptions options, Action<VTSItemUnloadResponseData> onSuccess,
            Action<VTSErrorData> onError)
        {
            ...
            request.data.allowUnloadingItemsLoadedByUserOrOtherPlugins =
                options.allowUnloadingItemsLoadedByUserOrOtherPlugins;
        ...
        {
            return await VTSExtensions.Async<VTSItemUnloadOptions, VTSItemUnloadResponseData, VTSErrorData>(UnloadItem,
                options);
        }

        // Animate Item

        public void AnimateItem(string itemInstanceID, VTSItemAnimationControlOptions options,
            Action<VTSItemAnimationControlResponseData> onSuccess, Action<VTSErrorData> onError)
        {
            ...
            this.Socket.Send<VTSItemAnimationControlRequestData, VTSItemAnimationControlResponseData>(request,
                onSuccess, onError);
        }

        public async Task<VTSItemAnimationControlResponseData> AnimateItem(string itemInstanceId,
            VTSItemAnimationControlOptions options)
        {
            return await VTSExtensions
                .Async<string, VTSItemAnimationControlOptions, VTSItemAnimationControlResponseData, VTSErrorData>(
                    AnimateItem, itemInstanceId, options);
        }

        // Move Item

        public void MoveItem(VTSItemMoveEntry[] items, Action<VTSItemMoveResponseData> onSuccess,
            Action<VTSErrorData> onError)
        {
        ...
        {
            return await VTSExtensions
                .Async<VTSItemMoveEntry[], VTSItemMoveResponseData, VTSErrorData>(MoveItem, items);
        }

        // Pin/Unpin Items

        private void PinItem(string itemInstanceID, VTSItemAngleRelativityMode angleRelativeTo,
            VTSItemSizeRelativityMode sizeRelativeTo, VTSVertexPinMode vertexPinType, ArtMeshCoordinate pinInfo,
            Action<VTSItemPinResponseData> onSuccess, Action<VTSErrorData> onError)
        {
        ...
        public void PinItemToCenter(string itemInstanceID, string modelID, string artMeshID, float angle,
            VTSItemAngleRelativityMode angleRelativeTo, float size, VTSItemSizeRelativityMode sizeRelativeTo,
            Action<VTSItemPinResponseData> onSuccess, Action<VTSErrorData> onError)
        {
            ...
            PinItem(itemInstanceID, angleRelativeTo, sizeRelativeTo, VTSVertexPinMode.Center, coordinate, onSuccess,
                onError);
        }

        public async Task<VTSItemPinResponseData> PinItemToCenter(string itemInstanceID, string modelID,
            string artMeshID, float angle, VTSItemAngleRelativityMode angleRelativeTo, float size,
            VTSItemSizeRelativityMode sizeRelativeTo)
        {
            return await VTSExtensions
                .Async<string, string, string, float, VTSItemAngleRelativityMode, float, VTSItemSizeRelativityMode,
                    VTSItemPinResponseData, VTSErrorData>(
                    PinItemToCenter, itemInstanceID, modelID, artMeshID, angle, angleRelativeTo, size, sizeRelativeTo);
        }

        public void PinItemToRandom(string itemInstanceID, string modelID, string artMeshID, float angle,
            VTSItemAngleRelativityMode angleRelativeTo, float size, VTSItemSizeRelativityMode sizeRelativeTo,
            Action<VTSItemPinResponseData> onSuccess, Action<VTSErrorData> onError)
        {
            ArtMeshCoordinate coordinate = new ArtMeshCoordinate
            ...
            PinItem(itemInstanceID, angleRelativeTo, sizeRelativeTo, VTSVertexPinMode.Random, coordinate, onSuccess,
                onError);
        }

        public async Task<VTSItemPinResponseData> PinItemToRandom(string itemInstanceID, string modelID,
            string artMeshID, float angle, VTSItemAngleRelativityMode angleRelativeTo, float size,
            VTSItemSizeRelativityMode sizeRelativeTo)
        {
            return await VTSExtensions
        ...
        public void PinItemToPoint(string itemInstanceID, string modelID, string artMeshID, float angle,
            VTSItemAngleRelativityMode angleRelativeTo, float size, VTSItemSizeRelativityMode sizeRelativeTo,
            BarycentricCoordinate point, Action<VTSItemPinResponseData> onSuccess, Action<VTSErrorData> onError)
        {
            ArtMeshCoordinate coordinate = new ArtMeshCoordinate
            {
                modelID = modelID,
            ...
            PinItem(itemInstanceID, angleRelativeTo, sizeRelativeTo, VTSVertexPinMode.Provided, coordinate, onSuccess,
                onError);
        }

        public async Task<VTSItemPinResponseData> PinItemToPoint(string itemInstanceID, string modelID,
            string artMeshID, float angle, VTSItemAngleRelativityMode angleRelativeTo, float size,
            VTSItemSizeRelativityMode sizeRelativeTo, BarycentricCoordinate point)
        {
            return await VTSExtensions
                .Async<string, string, string, float, VTSItemAngleRelativityMode, float, VTSItemSizeRelativityMode,
                    BarycentricCoordinate, VTSItemPinResponseData, VTSErrorData>(
                    PinItemToPoint, itemInstanceID, modelID, artMeshID, angle, angleRelativeTo, size, sizeRelativeTo,
                    point);
        }


        public void UnpinItem(string itemInsanceID, Action<VTSItemPinResponseData> onSuccess,
            Action<VTSErrorData> onError)
        {
            VTSItemPinRequestData request = new VTSItemPinRequestData();
        ...
        public void RequestArtMeshSelection(string textOverride, string helpOverride, int count,
            ICollection<string> activeArtMeshes, Action<VTSArtMeshSelectionResponseData> onSuccess,
            Action<VTSErrorData> onError)
        {
            ...
            this.Socket.Send<VTSArtMeshSelectionRequestData, VTSArtMeshSelectionResponseData>(request, onSuccess,
                onError);
        }

        public async Task<VTSArtMeshSelectionResponseData> RequestArtMeshSelection(string textOverride,
            string helpOverride, int count, ICollection<string> activeArtMeshes)
        {
            return await VTSExtensions
                .Async<string, string, int, ICollection<string>, VTSArtMeshSelectionResponseData, VTSErrorData>(
                    RequestArtMeshSelection, textOverride, helpOverride, count, activeArtMeshes);
        }

        // Request Permissions

        public void RequestPermission(VTSPermission permission, Action<VTSPermissionResponseData> onSuccess,
            Action<VTSErrorData> onError)
        {
        ...
        {
            return await VTSExtensions.Async<VTSPermission, VTSPermissionResponseData, VTSErrorData>(RequestPermission,
                permission);
        }
        ...
        private void SubscribeToEvent<T, K, V>(bool subscribed, V config, Action<K> onEvent,
            Action<VTSEventSubscriptionResponseData> onSubscribe, Action<VTSErrorData> onError)
            where T : VTSEventSubscriptionRequestData<V>, new() where K : VTSEventData where V : VTSEventConfigData
        {
            T request = new T();
        ...
        private async Task<VTSEventSubscriptionResponseData>
            SubscribeToEventAsync<T, K, V>(bool subscribed, V config, Action<K> onEvent)
            where T : VTSEventSubscriptionRequestData<V>, new() where K : VTSEventData where V : VTSEventConfigData
        {
        ...
        public void UnsubscribeFromAllEvents(Action<VTSEventSubscriptionResponseData> onUnsubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSUnsubscribeFromAllRequestData, VTSTestEventData, VTSTestEventConfigOptions>(false, null,
                DoNothingCallback, onUnsubscribe, onError);
        }
        ...
        public void SubscribeToTestEvent(VTSTestEventConfigOptions config, Action<VTSTestEventData> onEvent,
            Action<VTSEventSubscriptionResponseData> onSubscribe, Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSTestEventSubscriptionRequestData, VTSTestEventData, VTSTestEventConfigOptions>(true,
                config, onEvent, onSubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> SubscribeToTestEvent(VTSTestEventConfigOptions config,
            Action<VTSTestEventData> onEvent)
        {
            return await VTSExtensions
                .Async<VTSTestEventConfigOptions, Action<VTSTestEventData>, VTSEventSubscriptionResponseData,
                    VTSErrorData>(
                    SubscribeToTestEvent, config, onEvent);
        }

        public void UnsubscribeFromTestEvent(Action<VTSEventSubscriptionResponseData> onUnsubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSTestEventSubscriptionRequestData, VTSTestEventData, VTSTestEventConfigOptions>(false,
                null, DoNothingCallback, onUnsubscribe, onError);
        }
        ...
        public void SubscribeToModelLoadedEvent(VTSModelLoadedEventConfigOptions config,
            Action<VTSModelLoadedEventData> onEvent, Action<VTSEventSubscriptionResponseData> onSubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSModelLoadedEventSubscriptionRequestData, VTSModelLoadedEventData,
                VTSModelLoadedEventConfigOptions>(true, config, onEvent, onSubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> SubscribeToModelLoadedEvent(
            VTSModelLoadedEventConfigOptions config, Action<VTSModelLoadedEventData> onEvent)
        {
            return await VTSExtensions
                .Async<VTSModelLoadedEventConfigOptions, Action<VTSModelLoadedEventData>,
                    VTSEventSubscriptionResponseData, VTSErrorData>(
                    SubscribeToModelLoadedEvent, config, onEvent);
        }

        public void UnsubscribeFromModelLoadedEvent(Action<VTSEventSubscriptionResponseData> onUnsubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSModelLoadedEventSubscriptionRequestData, VTSTestEventData,
                VTSModelLoadedEventConfigOptions>(false, null, DoNothingCallback, onUnsubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> UnsubscribeFromModelLoadedEvent()
        {
            return await VTSExtensions.Async<VTSEventSubscriptionResponseData, VTSErrorData>(
                UnsubscribeFromModelLoadedEvent);
        }

        // Tracking Changed Event

        public void SubscribeToTrackingEvent(Action<VTSTrackingEventData> onEvent,
            Action<VTSEventSubscriptionResponseData> onSubscribe, Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSTrackingEventSubscriptionRequestData, VTSTrackingEventData,
                VTSTrackingEventConfigOptions>(true, new VTSTrackingEventConfigOptions(), onEvent, onSubscribe,
                onError);
        }

        public async Task<VTSEventSubscriptionResponseData> SubscribeToTrackingEvent(
            Action<VTSTrackingEventData> onEvent)
        {
            return await VTSExtensions
                .Async<Action<VTSTrackingEventData>, VTSEventSubscriptionResponseData, VTSErrorData>(
                    SubscribeToTrackingEvent, onEvent);
        }

        public void UnsubscribeFromTrackingEvent(Action<VTSEventSubscriptionResponseData> onUnsubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSTrackingEventSubscriptionRequestData, VTSTrackingEventData,
                VTSTrackingEventConfigOptions>(false, null, DoNothingCallback, onUnsubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> UnsubscribeFromTrackingEvent()
        {
            return await VTSExtensions.Async<VTSEventSubscriptionResponseData, VTSErrorData>(
                UnsubscribeFromTrackingEvent);
        }

        // Background Changed Event

        public void SubscribeToBackgroundChangedEvent(Action<VTSBackgroundChangedEventData> onEvent,
            Action<VTSEventSubscriptionResponseData> onSubscribe, Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSBackgroundChangedEventSubscriptionRequestData, VTSBackgroundChangedEventData,
                VTSBackgroundChangedEventConfigOptions>(true, new VTSBackgroundChangedEventConfigOptions(), onEvent,
                onSubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> SubscribeToBackgroundChangedEvent(
            Action<VTSBackgroundChangedEventData> onEvent)
        {
            return await VTSExtensions
                .Async<Action<VTSBackgroundChangedEventData>, VTSEventSubscriptionResponseData, VTSErrorData>(
                    SubscribeToBackgroundChangedEvent, onEvent);
        }

        public void UnsubscribeFromBackgroundChangedEvent(Action<VTSEventSubscriptionResponseData> onUnsubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSBackgroundChangedEventSubscriptionRequestData, VTSBackgroundChangedEventData,
                VTSBackgroundChangedEventConfigOptions>(false, null, DoNothingCallback, onUnsubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> UnsubscribeFromBackgroundChangedEvent()
        {
            return await VTSExtensions.Async<VTSEventSubscriptionResponseData, VTSErrorData>(
                UnsubscribeFromBackgroundChangedEvent);
        }

        // Model Config Changed Event

        public void SubscribeToModelConfigChangedEvent(Action<VTSModelConfigChangedEventData> onEvent,
            Action<VTSEventSubscriptionResponseData> onSubscribe, Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSModelConfigChangedEventSubscriptionRequestData, VTSModelConfigChangedEventData,
                VTSModelConfigChangedEventConfigOptions>(true, new VTSModelConfigChangedEventConfigOptions(), onEvent,
                onSubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> SubscribeToModelConfigChangedEvent(
            Action<VTSModelConfigChangedEventData> onEvent)
        {
            return await VTSExtensions
                .Async<Action<VTSModelConfigChangedEventData>, VTSEventSubscriptionResponseData, VTSErrorData>(
                    SubscribeToModelConfigChangedEvent, onEvent);
        }

        public void UnsubscribeFromModelConfigChangedEvent(Action<VTSEventSubscriptionResponseData> onUnsubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSModelConfigChangedEventSubscriptionRequestData, VTSModelConfigChangedEventData,
                VTSModelConfigChangedEventConfigOptions>(false, null, DoNothingCallback, onUnsubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> UnsubscribeFromModelConfigChangedEvent()
        {
            return await VTSExtensions.Async<VTSEventSubscriptionResponseData, VTSErrorData>(
                UnsubscribeFromModelConfigChangedEvent);
        }

        // Model Moved Event

        public void SubscribeToModelMovedEvent(Action<VTSModelMovedEventData> onEvent,
            Action<VTSEventSubscriptionResponseData> onSubscribe, Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSModelMovedEventSubscriptionRequestData, VTSModelMovedEventData,
                VTSModelMovedEventConfigOptions>(true, new VTSModelMovedEventConfigOptions(), onEvent, onSubscribe,
                onError);
        }

        public async Task<VTSEventSubscriptionResponseData> SubscribeToModelMovedEvent(
            Action<VTSModelMovedEventData> onEvent)
        {
            return await VTSExtensions
                .Async<Action<VTSModelMovedEventData>, VTSEventSubscriptionResponseData, VTSErrorData>(
                    SubscribeToModelMovedEvent, onEvent);
        }

        public void UnsubscribeFromModelMovedEvent(Action<VTSEventSubscriptionResponseData> onUnsubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSModelMovedEventSubscriptionRequestData, VTSModelMovedEventData,
                VTSModelMovedEventConfigOptions>(false, null, DoNothingCallback, onUnsubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> UnsubscribeFromModelMovedEvent()
        {
            return await VTSExtensions.Async<VTSEventSubscriptionResponseData, VTSErrorData>(
                UnsubscribeFromModelMovedEvent);
        }

        // Model Outline Event

        public void SubscribeToModelOutlineEvent(VTSModelOutlineEventConfigOptions config,
            Action<VTSModelOutlineEventData> onEvent, Action<VTSEventSubscriptionResponseData> onSubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSModelOutlineEventSubscriptionRequestData, VTSModelOutlineEventData,
                VTSModelOutlineEventConfigOptions>(true, config, onEvent, onSubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> SubscribeToModelOutlineEvent(
            VTSModelOutlineEventConfigOptions config, Action<VTSModelOutlineEventData> onEvent)
        {
            return await VTSExtensions
                .Async<VTSModelOutlineEventConfigOptions, Action<VTSModelOutlineEventData>,
                    VTSEventSubscriptionResponseData, VTSErrorData>(
                    SubscribeToModelOutlineEvent, config, onEvent);
        }

        public void UnsubscribeFromModelOutlineEvent(Action<VTSEventSubscriptionResponseData> onUnsubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSModelOutlineEventSubscriptionRequestData, VTSModelOutlineEventData,
                VTSModelOutlineEventConfigOptions>(false, null, DoNothingCallback, onUnsubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> UnsubscribeFromModelOutlineEvent()
        {
            return await VTSExtensions.Async<VTSEventSubscriptionResponseData, VTSErrorData>(
                UnsubscribeFromModelOutlineEvent);
        }

        // Hotkey Triggered Event

        public void SubscribeToHotkeyTriggeredEvent(VTSHotkeyTriggeredEventConfigOptions config,
            Action<VTSHotkeyTriggeredEventData> onEvent, Action<VTSEventSubscriptionResponseData> onSubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSHotkeyTriggeredEventSubscriptionRequestData, VTSHotkeyTriggeredEventData,
                VTSHotkeyTriggeredEventConfigOptions>(true, config, onEvent, onSubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> SubscribeToHotkeyTriggeredEvent(
            VTSHotkeyTriggeredEventConfigOptions config, Action<VTSHotkeyTriggeredEventData> onEvent)
        {
            return await VTSExtensions
                .Async<VTSHotkeyTriggeredEventConfigOptions, Action<VTSHotkeyTriggeredEventData>,
                    VTSEventSubscriptionResponseData, VTSErrorData>(
                    SubscribeToHotkeyTriggeredEvent, config, onEvent);
        }

        public void UnsubscribeFromHotkeyTriggeredEvent(Action<VTSEventSubscriptionResponseData> onUnsubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSHotkeyTriggeredEventSubscriptionRequestData, VTSHotkeyTriggeredEventData,
                VTSHotkeyTriggeredEventConfigOptions>(false, null, DoNothingCallback, onUnsubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> UnsubscribeFromHotkeyTriggeredEvent()
        {
            return await VTSExtensions.Async<VTSEventSubscriptionResponseData, VTSErrorData>(
                UnsubscribeFromHotkeyTriggeredEvent);
        }

        // Animation Event Triggered Event

        public void SubscribeToModelAnimationEvent(VTSModelAnimationEventConfigOptions config,
            Action<VTSModelAnimationEventData> onEvent, Action<VTSEventSubscriptionResponseData> onSubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSModelAnimationEventSubscriptionRequestData, VTSModelAnimationEventData,
                VTSModelAnimationEventConfigOptions>(true, config, onEvent, onSubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> SubscribeToModelAnimationEvent(
            VTSModelAnimationEventConfigOptions config, Action<VTSModelAnimationEventData> onEvent)
        {
            return await VTSExtensions
                .Async<VTSModelAnimationEventConfigOptions, Action<VTSModelAnimationEventData>,
                    VTSEventSubscriptionResponseData, VTSErrorData>(
                    SubscribeToModelAnimationEvent, config, onEvent);
        }

        public void UnsubscribeFromModelAnimationEvent(Action<VTSEventSubscriptionResponseData> onUnsubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSModelAnimationEventSubscriptionRequestData, VTSModelAnimationEventData,
                VTSModelAnimationEventConfigOptions>(false, null, DoNothingCallback, onUnsubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> UnsubscribeFromModelAnimationEvent()
        {
            return await VTSExtensions.Async<VTSEventSubscriptionResponseData, VTSErrorData>(
                UnsubscribeFromModelAnimationEvent);
        }

        // Item Event

        public void SubscribeToItemEvent(VTSItemEventConfigOptions config, Action<VTSItemEventData> onEvent,
            Action<VTSEventSubscriptionResponseData> onSubscribe, Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSItemEventSubscriptionRequestData, VTSItemEventData, VTSItemEventConfigOptions>(true,
                config, onEvent, onSubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> SubscribeToItemEvent(VTSItemEventConfigOptions config,
            Action<VTSItemEventData> onEvent)
        {
            return await VTSExtensions
                .Async<VTSItemEventConfigOptions, Action<VTSItemEventData>, VTSEventSubscriptionResponseData,
                    VTSErrorData>(
                    SubscribeToItemEvent, config, onEvent);
        }

        public void UnsubscribeFromItemEvent(Action<VTSEventSubscriptionResponseData> onUnsubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSItemEventSubscriptionRequestData, VTSItemEventData, VTSItemEventConfigOptions>(false,
                null, DoNothingCallback, onUnsubscribe, onError);
        }
        ...
        public void SubscribeToModelClickedEvent(VTSModelClickedEventConfigOptions config,
            Action<VTSModelClickedEventData> onEvent, Action<VTSEventSubscriptionResponseData> onSubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSModelClickedEventSubscriptionRequestData, VTSModelClickedEventData,
                VTSModelClickedEventConfigOptions>(true, config, onEvent, onSubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> SubscribeToModelClickedEvent(
            VTSModelClickedEventConfigOptions config, Action<VTSModelClickedEventData> onEvent)
        {
            return await VTSExtensions
                .Async<VTSModelClickedEventConfigOptions, Action<VTSModelClickedEventData>,
                    VTSEventSubscriptionResponseData, VTSErrorData>(
                    SubscribeToModelClickedEvent, config, onEvent);
        }

        public void UnsubscribeFromModelClickedEvent(Action<VTSEventSubscriptionResponseData> onUnsubscribe,
            Action<VTSErrorData> onError)
        {
            SubscribeToEvent<VTSModelClickedEventSubscriptionRequestData, VTSModelClickedEventData,
                VTSModelClickedEventConfigOptions>(false, null, DoNothingCallback, onUnsubscribe, onError);
        }

        public async Task<VTSEventSubscriptionResponseData> UnsubscribeFromModelClickedEvent()
        {
            return await VTSExtensions.Async<VTSEventSubscriptionResponseData, VTSErrorData>(
                UnsubscribeFromModelClickedEvent);
        }
